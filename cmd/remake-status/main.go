...
func main() {
	...
	for _, key := range []string{"charged_items", "cell_sweep", "fp_screens", "monster_ai", "table_dispatch", "treasure_sites", "proofread", "audio_triggers", "music_triggers", "sound_triggers", "dos_sound_map", "campaign_frames"} {
