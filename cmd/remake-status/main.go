...
func main() {
	...
	for _, key := range []string{"charged_items", "cell_sweep", "cell_revisit", "cell_random_branches", "cell_reachability", "fp_screens", "monster_ai", "table_dispatch", "treasure_sites", "proofread", "audio_triggers", "music_triggers", "sound_triggers", "dos_sound_map", "campaign_frames", "player_input_path"} {
