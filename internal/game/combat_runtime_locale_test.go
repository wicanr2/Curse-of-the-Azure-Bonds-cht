...
func TestCombatRuntimeKeysHaveFormalTranslations(t *testing.T) {
	...
	keys := []string{
		...
		"combat_lightning_bolt_resisted", "combat_lightning_bolt_protected_resisted",
		"combat_stinking_cloud", "combat_cloudkill", "combat_sleep", "combat_fireball",
		"combat_fireball_protected", "combat_fireball_resisted", "combat_fireball_protected_resisted",
		"combat_visual_line_resisted", "combat_visual_fireball_resisted",
		"combat_protection_from_good", "combat_protection_from_evil",
		"combat_cause_light_wounds", "combat_curse_immune", "combat_curse", "combat_bless",
		"combat_cure_light_wounds", "combat_done", "combat_menu_item_move", "combat_menu_item_view",
		"combat_menu_item_aim", "combat_menu_item_use", "combat_menu_item_cast",
		"combat_menu_item_quick", "combat_menu_item_done", "combat_menu_guard",
		"combat_menu_delay", "combat_menu_quit", "combat_menu_bandage", "combat_menu_speed",
		"combat_menu_exit", "combat_menu_turn_undead", "combat_turn_undead",
		"combat_turn_undead_turned", "combat_turn_undead_destroyed",
		"combat_turn_undead_nothing",
		"combat_guard", "combat_bandage", "combat_quick_all",
		...
		"combat_monster_lightning_bolt_resisted", "combat_monster_lightning_bolt_protected_resisted",
