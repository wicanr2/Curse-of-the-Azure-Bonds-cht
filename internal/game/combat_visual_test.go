...
func TestCombatVisualMessageUsesTypedPhaseAndFormalLocale(t *testing.T) {
	...
	tests := []struct {
		...
		{"line magic resistance", combat.VisualEvent{Kind: combat.VisualLineSpell, Impacts: []combat.VisualImpactTarget{{TargetID: "target", Resisted: true}}}, combat.VisualFrame{Phase: combat.VisualImpact, ImpactIndex: 0}, "combat_visual_line_resisted", []any{"TARGET"}, false},
		{"fireball magic resistance", combat.VisualEvent{Kind: combat.VisualAreaSpell, Effect: "fireball", Impacts: []combat.VisualImpactTarget{{TargetID: "target", Resisted: true}}}, combat.VisualFrame{Phase: combat.VisualImpact, ImpactIndex: 0}, "combat_visual_fireball_resisted", []any{"TARGET"}, false},
