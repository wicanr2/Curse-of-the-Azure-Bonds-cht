...
func TestParseMonsterRecordOffsets(t *testing.T) {
	...
	if record.Name != "ORC!!" || record.MaxHitPoints != 12 || record.HitPoints != 9 || record.ArmorClass != 10 || record.AttackBonus != 3 || record.DamageDiceSides != 8 || record.DamageBonus != 2 || record.AttacksPerTurn != 3 || record.CombatSize != 4 {
	...
	if fighter.ID != "orc-1" || fighter.Side != combat.SideEnemy || fighter.HitPoints != 9 || fighter.AttacksPerTurn != 3 || fighter.CombatSize != 4 || len(fighter.MonsterSpellIDs) != 1 || fighter.MonsterSpellUses[0] != 1 {
