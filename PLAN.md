...
- [x] 建立 State default hit resolver，投影 fighter／equipment AC 並套用已證實的 invisibility `0x19`／`0x47` -4 與 action-delay-aware blink `0x25`；displace／其他 affect／death continuation 仍待補證。
