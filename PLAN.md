...
- [x] 依 reference `CheckAffectsEffect(Death)` 接入 affect_63 recovery、Bleeding、troll_fire_or_acid damage-flag gate／TrollRegen `0x66`，以及 explicit dragon-slayer `0x4B` target context；其他 Death routine 仍待接入。
