...
目前列出 22 個可由現有 evidence 同時通過種族職業限制與起始年齡表的組合：人類 6、矮人
2、精靈 3、侏儒 2、半精靈 4、半身人 2、半獸人 3。多職業／dual-class 與完整原版建立
流程仍未臆測加入。

## 實作

- `starterCharacters` 產生所有 22 個單職業選項，使用各職業合法的 deterministic baseline abilities；半獸人 cleric／fighter／thief 的 age entry 已依 reference class index 接線。
...
- `TestCharacterCreationListsVerifiedSingleClassOptions` 驗證 22 個選項全部通過 `Character.Validate`
