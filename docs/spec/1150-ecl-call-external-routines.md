...
0 或非 0 把 `4FBAh` 設成 3 或 4（`overlay-07:0DA0h`..`0DC9h`）。而 `4BE6h` 就是
**第一人稱（3D 地圖）模式旗標**（spec 1096／1181）⇒ 3 ＝ 非第一人稱、
4 ＝ 第一人稱，`PICTURE 0FFh` 那句「兩個都等於 4 就不重繪」讀作
**「前後都還在第一人稱就不重繪」**（spec 1148 的表）。
