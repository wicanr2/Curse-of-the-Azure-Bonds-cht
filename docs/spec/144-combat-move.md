...
- 未施法時原本的 enemy target cursor 保持不變；移動模式不會誤觸攻擊／施法。第 145 輪已補上離開敵人鄰接範圍的 free attack。

## 明確 boundary

本輪仍未猜測地形／戰場邊界、負重／護甲 movement allowance、進入敵方格的攻擊、facing、離場 flee 與完整 movement animation；第 145 輪已接入 adjacency transition 的 free attack trigger。
