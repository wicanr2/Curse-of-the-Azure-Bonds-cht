...
| 狀態 | 指令數 | opcode 數 | 意思 |
|---|---:|---:|---|
| `done` | 13153 | 52 | 副作用已產生，且有回歸測試或實機路徑驗過 |
| `partial` | 1024 | 9 | 只做了一部分，多半是把請求記進 result 讓上層處理 |
...
| `ECL4.DAX/0x20` | 722 | 63 |
| `ECL4.DAX/0x21` | 563 | 60 |
| `ECL5.DAX/0x33` | 709 | 59 |
| `ECL3.DAX/0x10` | 913 | 57 |
| `ECL5.DAX/0x32` | 634 | 55 |
| `ECL6.DAX/0x40` | 766 | 54 |
| `ECL3.DAX/0x12` | 840 | 52 |
| `ECL4.DAX/0x22` | 526 | 50 |
| `ECL2.DAX/0x01` | 659 | 46 |
| `ECL3.DAX/0x11` | 788 | 46 |
| `ECL5.DAX/0x35` | 598 | 43 |
| `ECL2.DAX/0x03` | 703 | 42 |
| `ECL2.DAX/0x02` | 374 | 40 |
| `ECL6.DAX/0x42` | 603 | 37 |
| `ECL6.DAX/0x43` | 525 | 33 |
| `ECL1.DAX/0x50` | 798 | 32 |
| `ECL1.DAX/0x51` | 726 | 32 |
| `ECL2.DAX/0x04` | 482 | 29 |
| `ECL5.DAX/0x31` | 388 | 24 |
| `ECL4.DAX/0x23` | 303 | 21 |
