...
| 狀態 | 指令數 | opcode 數 | 意思 |
|---|---:|---:|---|
| `done` | 13446 | 55 | 副作用已產生，且有回歸測試或實機路徑驗過 |
| `partial` | 731 | 6 | 只做了一部分，多半是把請求記進 result 讓上層處理 |
...
| Block | 可達指令 | 其中未完整還原 |
|---|---:|---:|
| `ECL4.DAX/0x25` | 745 | 57 |
| `ECL4.DAX/0x21` | 563 | 54 |
| `ECL4.DAX/0x20` | 722 | 47 |
| `ECL3.DAX/0x10` | 913 | 41 |
| `ECL3.DAX/0x11` | 788 | 39 |
| `ECL3.DAX/0x12` | 840 | 39 |
| `ECL5.DAX/0x33` | 709 | 39 |
| `ECL2.DAX/0x01` | 659 | 38 |
| `ECL4.DAX/0x22` | 526 | 37 |
| `ECL5.DAX/0x32` | 634 | 36 |
| `ECL6.DAX/0x40` | 766 | 35 |
| `ECL2.DAX/0x02` | 374 | 30 |
| `ECL6.DAX/0x42` | 603 | 27 |
| `ECL5.DAX/0x35` | 598 | 26 |
| `ECL6.DAX/0x43` | 525 | 26 |
| `ECL2.DAX/0x03` | 703 | 25 |
| `ECL4.DAX/0x23` | 303 | 20 |
| `ECL2.DAX/0x04` | 482 | 19 |
| `ECL5.DAX/0x31` | 388 | 19 |
| `ECL1.DAX/0x50` | 798 | 18 |
| `ECL1.DAX/0x52` | 86 | 18 |
| `ECL1.DAX/0x51` | 726 | 17 |
| `ECL3.DAX/0x15` | 334 | 13 |
| `ECL6.DAX/0x45` | 320 | 11 |
| `ECL5.DAX/0x30` | 72 | 0 |
