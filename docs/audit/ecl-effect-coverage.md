...
| 狀態 | 指令數 | opcode 數 | 意思 |
|---|---:|---:|---|
| `done` | 13690 | 58 | 副作用已產生，且有回歸測試或實機路徑驗過 |
| `partial` | 487 | 3 | 只做了一部分，多半是把請求記進 result 讓上層處理 |
...
| Block | 可達指令 | 其中未完整還原 |
|---|---:|---:|
| `ECL4.DAX/0x21` | 563 | 47 |
| `ECL4.DAX/0x25` | 745 | 35 |
| `ECL4.DAX/0x20` | 722 | 34 |
| `ECL4.DAX/0x22` | 526 | 32 |
| `ECL2.DAX/0x01` | 659 | 31 |
| `ECL3.DAX/0x10` | 913 | 30 |
| `ECL3.DAX/0x11` | 788 | 29 |
| `ECL3.DAX/0x12` | 840 | 28 |
| `ECL5.DAX/0x33` | 709 | 24 |
| `ECL6.DAX/0x40` | 766 | 22 |
| `ECL6.DAX/0x42` | 603 | 20 |
| `ECL6.DAX/0x43` | 525 | 20 |
| `ECL2.DAX/0x02` | 374 | 19 |
| `ECL4.DAX/0x23` | 303 | 19 |
