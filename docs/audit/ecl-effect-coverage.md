...
| 狀態 | 指令數 | opcode 數 | 意思 |
|---|---:|---:|---|
| `done` | 13359 | 53 | 副作用已產生，且有回歸測試或實機路徑驗過 |
| `partial` | 818 | 8 | 只做了一部分，多半是把請求記進 result 讓上層處理 |
...
| Block | 可達指令 | 其中未完整還原 |
|---|---:|---:|
| `ECL4.DAX/0x25` | 745 | 70 |
| `ECL4.DAX/0x21` | 563 | 56 |
| `ECL4.DAX/0x20` | 722 | 52 |
| `ECL3.DAX/0x10` | 913 | 48 |
| `ECL5.DAX/0x33` | 709 | 46 |
| `ECL6.DAX/0x40` | 766 | 43 |
| `ECL4.DAX/0x22` | 526 | 42 |
| `ECL3.DAX/0x12` | 840 | 41 |
| `ECL2.DAX/0x01` | 659 | 40 |
| `ECL3.DAX/0x11` | 788 | 40 |
| `ECL5.DAX/0x32` | 634 | 40 |
| `ECL5.DAX/0x35` | 598 | 32 |
| `ECL6.DAX/0x42` | 603 | 32 |
| `ECL2.DAX/0x02` | 374 | 31 |
| `ECL6.DAX/0x43` | 525 | 29 |
| `ECL2.DAX/0x03` | 703 | 28 |
| `ECL2.DAX/0x04` | 482 | 23 |
| `ECL1.DAX/0x50` | 798 | 20 |
| `ECL4.DAX/0x23` | 303 | 20 |
| `ECL5.DAX/0x31` | 388 | 20 |
| `ECL1.DAX/0x51` | 726 | 19 |
| `ECL1.DAX/0x52` | 86 | 18 |
| `ECL3.DAX/0x15` | 334 | 14 |
| `ECL6.DAX/0x45` | 320 | 14 |
| `ECL5.DAX/0x30` | 72 | 0 |
