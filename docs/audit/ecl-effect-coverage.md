...
| 狀態 | 指令數 | opcode 數 | 意思 |
|---|---:|---:|---|
| `done` | 13469 | 56 | 副作用已產生，且有回歸測試或實機路徑驗過 |
| `partial` | 708 | 5 | 只做了一部分，多半是把請求記進 result 讓上層處理 |
...
| Block | 可達指令 | 其中未完整還原 |
|---|---:|---:|
| `ECL4.DAX/0x25` | 745 | 56 |
| `ECL4.DAX/0x21` | 563 | 50 |
| `ECL4.DAX/0x20` | 722 | 46 |
| `ECL3.DAX/0x10` | 913 | 40 |
| `ECL3.DAX/0x12` | 840 | 39 |
| `ECL5.DAX/0x33` | 709 | 38 |
| `ECL2.DAX/0x01` | 659 | 37 |
| `ECL3.DAX/0x11` | 788 | 37 |
| `ECL4.DAX/0x22` | 526 | 36 |
| `ECL5.DAX/0x32` | 634 | 35 |
| `ECL6.DAX/0x40` | 766 | 34 |
| `ECL2.DAX/0x02` | 374 | 29 |
| `ECL6.DAX/0x42` | 603 | 26 |
| `ECL5.DAX/0x35` | 598 | 25 |
| `ECL6.DAX/0x43` | 525 | 25 |
| `ECL2.DAX/0x03` | 703 | 24 |
| `ECL4.DAX/0x23` | 303 | 20 |
| `ECL1.DAX/0x50` | 798 | 18 |
| `ECL1.DAX/0x52` | 86 | 18 |
| `ECL2.DAX/0x04` | 482 | 18 |
| `ECL5.DAX/0x31` | 388 | 18 |
| `ECL1.DAX/0x51` | 726 | 17 |
| `ECL3.DAX/0x15` | 334 | 12 |
| `ECL6.DAX/0x45` | 320 | 10 |
| `ECL5.DAX/0x30` | 72 | 0 |
