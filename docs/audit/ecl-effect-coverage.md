...
| 狀態 | 指令數 | opcode 數 | 意思 |
|---|---:|---:|---|
| `done` | 14177 | 61 | 副作用已產生，且有回歸測試或實機路徑驗過 |
| `partial` | 0 | 0 | 只做了一部分，多半是把請求記進 result 讓上層處理 |
