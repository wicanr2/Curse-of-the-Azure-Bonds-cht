...
| `1Ch` | CLEARMONSTERS | 0 | `120Eh` | `120Eh`..`1271h` | 37 | `done` |
...
| `24h` | COMBAT | 0 | `179Ah` | `179Ah`..`17B5h` | 18 | `done` |
| `26h` | ON GOSUB | 0 | `1A9Bh` | `1A9Bh`..`1B30h` | 57 | `done` |
| `27h` | TREASURE | 8 | `1B53h` | `1B53h`..`1F46h` | 398 | `done` |
...
| `37h` | LOAD PIECES | 3 | `0C15h` | `0C15h`..`0DA3h` | 131 | `done` |
