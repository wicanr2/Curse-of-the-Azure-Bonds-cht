...
| 檔案 | 字串數 |
|---|---:|
| `gamepack/pack/20-locale.zh-TW.json` | 1472 |
...
| `Hillsfar` | 希爾斯法 | 8 | — |
| `Mulmaster` | 穆爾馬斯特 | 4 | — |
| `Myth Drannor` | 迷斯卓諾 | 16 | — |
| `Pit of Moander` | 摩安德之坑 | 5 | — |
| `Shadowdale` | 暗影谷 | 16 | — |
| `Standing Stones` | 立石群 | 7 | — |
| `Teshwave` | 特什維夫 | 8 | — |
| `Tilverton` | 提爾佛頓 | 22 | — |
| `Yulash` | 尤拉什 | 21 | — |
| `Zhentil Keep` | 散提爾堡 | 38 | 散塔林堡 |
...
| `RUSTLE` | 拉梭 | 1 | — |
| `SALAMANDER` | 火蜥蜴 | 6 | — |
| `SHAMBLING MOUND` | 蔓生怪 | 14 | — |
| `SM VEGEPYGMY` | 小型菌人 | 1 | — |
| `THIEF` | 盜賊 | 23 | — |
| `THRI-KREEN` | 斯瑞克林 | 3 | — |
| `TROLL` | 巨魔 | 8 | — |
| `TYRANTHRAXUS` | 提朗瑟克斯 | 20 | — |
| `WORG` | 座狼 | 4 | — |
| `WYVERN` | 雙足飛龍 | 1 | — |
