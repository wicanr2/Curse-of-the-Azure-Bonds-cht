...
模組 37／函式 1386：已解讀 966、不阻塞 133、邊界碎片 237、待解讀 50；已定義程式碼 260651 bytes，未定義 16065 bytes。
...
模組 37／函式 1488：已解讀 1068、不阻塞 29、邊界碎片 338、待解讀 53；已定義程式碼 270352 bytes，未定義 20321 bytes。
