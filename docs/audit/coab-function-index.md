...
模組 37／函式 1386：已解讀 1004、不阻塞 133、邊界碎片 237、待解讀 12；已定義程式碼 260651 bytes，未定義 16065 bytes。
...
模組 37／函式 1488：已解讀 1111、不阻塞 29、邊界碎片 338、待解讀 10；已定義程式碼 270352 bytes，未定義 20321 bytes。
...
| overlay-26 | MENUS | 20 | 19 | 0 | 0 | 1 | 4937 | 183 | [明細](function-index/pc98-overlay-26.md) |
