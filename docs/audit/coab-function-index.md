...
模組 37／函式 1386：已解讀 653、不阻塞 133、邊界碎片 249、待解讀 351；已定義程式碼 260651 bytes，未定義 16065 bytes。
...
| overlay-14 | MOVEMENT | 14 | 8 | 0 | 0 | 6 | 3735 | 308 | [明細](function-index/dos-overlay-14.md) |
...
模組 37／函式 1488：已解讀 719、不阻塞 29、邊界碎片 340、待解讀 400；已定義程式碼 270352 bytes，未定義 20321 bytes。
