...
模組 37／函式 1386：已解讀 285、不阻塞 133、邊界碎片 208、待解讀 760；已定義程式碼 260651 bytes，未定義 16065 bytes。
...
模組 37／函式 1489：已解讀 322、不阻塞 29、邊界碎片 280、待解讀 858；已定義程式碼 270359 bytes，未定義 20321 bytes。
