...
模組 37／函式 1488：已解讀 475、不阻塞 29、邊界碎片 336、待解讀 648；已定義程式碼 270352 bytes，未定義 20321 bytes。

| 模組 | 原始單元 | 函式 | 已解讀 | 不阻塞 | 碎片 | 待解讀 | 程式碼 | 未定義 | 明細 |
|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| PC98-GAME.EXE | — | 333 | 133 | 29 | 21 | 150 | 25067 | 0 | [明細](function-index/pc98-PC98-GAME.EXE.md) |
