...
模組 37／函式 1386：已解讀 1014、不阻塞 133、邊界碎片 237、待解讀 2；已定義程式碼 260651 bytes，未定義 16065 bytes。

| 模組 | 原始單元 | 函式 | 已解讀 | 不阻塞 | 碎片 | 待解讀 | 程式碼 | 未定義 | 明細 |
|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| START.EXE | — | 325 | 171 | 133 | 20 | 1 | 23290 | 0 | [明細](function-index/dos-START.EXE.md) |
...
模組 37／函式 1488：已解讀 1118、不阻塞 29、邊界碎片 338、待解讀 3；已定義程式碼 270352 bytes，未定義 20321 bytes。

| 模組 | 原始單元 | 函式 | 已解讀 | 不阻塞 | 碎片 | 待解讀 | 程式碼 | 未定義 | 明細 |
|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| PC98-GAME.EXE | — | 333 | 278 | 29 | 25 | 1 | 25067 | 0 | [明細](function-index/pc98-PC98-GAME.EXE.md) |
