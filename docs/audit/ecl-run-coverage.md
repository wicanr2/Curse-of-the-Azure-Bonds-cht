...
| 段 | 起點位址 | 連續未執行指令數 |
|---|---|---:|
| `ECL4.DAX/0x25` | `0x822E` | 667 |
| `ECL5.DAX/0x35` | `0x8014` | 598 |
| `ECL3.DAX/0x15` | `0x8014` | 334 |
| `ECL6.DAX/0x45` | `0x8014` | 320 |
