...
| `0057` | sub_57 | GAINWEIGHT | 28 | 10 | 4 | 0 | ✓ | 已解讀 | exact | docs/spec/637-overlay21-small-batch.md<br>arg_2^[188h] += arg_0(word)。與 003Bh 成對 | audit/embedded-strings.md<br>audit/function-index/dos-overlay-21.md<br>audit/function-index/pc98-overlay-04.md<br>audit/function-index/pc98-overlay-21.md<br>spec/637-overlay21-small-batch.md<br>spec/786-money-pool-overflow-and-turn-cost.md |
| `0073` | sub_73 | TOOHEAVY | 84 | 31 | 3 | 2 | ✓ | 已解讀 | exact | docs/spec/756-map-fill-confirms-grid-and-assorted-routines.md<br>會不會超過上限(retf 0Ah)：欄位是 +188h，其餘與 DOS overlay-21:0073h 相同 | audit/function-index/dos-overlay-21.md<br>audit/function-index/pc98-overlay-21.md<br>spec/755-per-character-slots-sound-driver-and-text-io.md<br>spec/756-map-fill-confirms-grid-and-assorted-routines.md<br>spec/762-ega-glyph-blit-and-movement-rate.md<br>spec/786-money-pool-overflow-and-turn-cost.md |
...
| `0218` | sub_218 | ADDPLATINUM | 145 | 53 | 0 | 4 | ✓ | 已解讀 | exact | docs/spec/786-money-pool-overflow-and-turn-cost.md<br>拿不動的錢放進 Pool(retf 2)：與 DOS overlay-21:021Ch 53 條同形，訊息 CS:01F3h '持ちすぎです。お金は地面に置きますよ'、Pool 在 DS:0A01Ah(差異 17 條，已逐條列出) | audit/embedded-strings.md |
