...
| `0B9B` | sub_B9B | — | 376 | 163 | 1 | 4 | ✓ | 已解讀 | exact | docs/spec/996-pc98-ending-sequence.md<br>結局圖片序列 CED1..CED8 自動輪播（每張 1000 計時單位）＋ CED9 停住；先清三個圖形平面各半個（3E80h） | audit/function-strings.md<br>spec/996-pc98-ending-sequence.md |
