...
| `0000` | sub_0 | LOADLIBRARY | 57 | 15 | 0 | 7 | ✓ | 已解讀 | exact | docs/spec/569-small-function-batch-reading.md<br>呼叫序列：依序執行 10 個呼叫，沒有其他動作：`call far ptr loc_1695+2`、`call far ptr sub_17B7`、`call far ptr loc_11C4+3`、`call sub_147D`、`call far ptr sub_1154`、`call far ptr loc_1083+1`（body 共 57 bytes，已逐條讀完） | audit/embedded-strings.md<br>audit/function-index/dos-overlay-04.md<br>audit/function-index/dos-overlay-12.md<br>audit/function-index/dos-overlay-15.md<br>audit/function-index/dos-overlay-17.md<br>audit/overlay-init-graph.md |
...
| `0E8E` | sub_E8E | — | 247 | 101 | 1 | 4 | ✓ | 待解讀 | — | — | — |
| `1074` | sub_1074 | VIEWITEM | 289 | 143 | 1 | 1 | ✓ | 待解讀 | — | — | — |
...
| `15A1` | sub_15A1 | — | 125 | 42 | 2 | 1 |  | 邊界碎片 | — | docs/spec/587-ecl-handler-21-37-shared.md<br>邊界碎片：落在 1578h 的 prologue 區間內部，自己不是 prologue。所屬函式尚未解讀，讀它時會一併涵蓋。 | — |
| `1604` | sub_1604 | — | 15 | 5 | 3 | 0 |  | 邊界碎片 | — | docs/spec/569-small-function-batch-reading.md<br>邊界碎片：body 內沒有 `ret` 也沒有尾跳躍，最後一條是 `mov byte ptr ds:0A335h, 52h`；這是 IDA 建錯的函式邊界，真正的函式體要以位址範圍重讀（body 共 15 bytes，已逐條讀完） | — |
...
| `1EAE` | sub_1EAE | READYITEM | 487 | 176 | 1 | 2 | ✓ | 待解讀 | — | — | — |
...
| `27DC` | sub_27DC | — | 482 | 183 | 1 | 5 | ✓ | 待解讀 | — | — | — |
| `2A32` | sub_2A32 | — | 482 | 199 | 1 | 4 | ✓ | 待解讀 | — | — | — |
| `2A32` | sub_2A32 | — | 482 | 199 | 1 | 5 | ✓ | 待解讀 | — | — | — |
| `2C69` | sub_2C69 | — | 828 | 321 | 1 | 7 | ✓ | 待解讀 | — | — | — |
| `2C69` | sub_2C69 | — | 828 | 321 | 1 | 6 | ✓ | 待解讀 | — | — | — |
| `2FE5` | sub_2FE5 | — | 722 | 283 | 1 | 4 | ✓ | 待解讀 | — | — | — |
...
| `340A` | sub_340A | CASH | 117 | 44 | 1 | 1 | ✓ | 待解讀 | — | — | — |
| `34E4` | sub_34E4 | PICKSPELL | 372 | 157 | 2 | 5 | ✓ | 待解讀 | — | — | — |
