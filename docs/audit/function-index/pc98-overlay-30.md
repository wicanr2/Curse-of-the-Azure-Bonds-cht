...
| `016B` | sub_16B | SET3DCOLORS | 33 | 13 | 0 | 0 | ✓ | 已解讀 | exact | docs/spec/753-small-utility-routines.md<br>四個 byte 的 setter(retf 8)：依序寫 DS:0A2A4h..0A2A7h，與 DOS overlay-30:016Bh 同 | audit/embedded-strings.md<br>spec/519-dos-overlay-vector-to-cell-layer-accessor.md<br>spec/753-small-utility-routines.md |
