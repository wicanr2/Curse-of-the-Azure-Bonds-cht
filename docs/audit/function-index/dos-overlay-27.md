...
| `0032` | sub_32 | — | 49 | 15 | 0 | 0 | ✓ | 已解讀 | exact | docs/spec/753-small-utility-routines.md<br>兩次繪製(retf，無參數)：0297h:0EFFh(DS:8C78h, DS:8C7Ah, 遠指標@DS:65CAh) 與 0297h:1110h(DS:8C78h, DS:8C7Ah, 遠指標@DS:8C7Ch)。參數形狀由推入順序解出：末兩個 word 先高後低＝一個遠指標 | audit/function-index/dos-overlay-02.md<br>audit/function-index/dos-overlay-26.md<br>audit/function-index/pc98-overlay-27.md<br>spec/1060-option-row-menu-core.md<br>spec/753-small-utility-routines.md |
