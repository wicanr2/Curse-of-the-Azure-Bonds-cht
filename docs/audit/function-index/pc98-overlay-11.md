...
| `07CD` | sub_7CD | — | 51 | 27 | 1 | 2 | ✓ | 已解讀 | exact | docs/spec/755-per-character-slots-sound-driver-and-text-io.md<br>16 色調色盤設定(retn 2)：out 6Ah,1 切 16 色；依參數選 CS:076Dh(非 0)或 CS:079Dh(0)這兩份 16×3=48 bytes 的調色盤，經 0A8h/0AAh/0ACh/0AEh 寫入(索引/綠/紅/藍，索引遞減)；再 int 18h AH=42h/40h/12h 與 out 68h,8。IDA 的 ROM BASIC 註解是 IBM PC 語意，PC-98 不適用 | spec/755-per-character-slots-sound-driver-and-text-io.md<br>spec/775-take-menu-and-palette-writer.md |
