...
| `0800` | sub_800 | — | 40 | 26 | 1 | 1 |  | 已解讀 | exact | docs/spec/775-take-menu-and-palette-writer.md<br>寫入 16 組調色盤(近呼叫 retn，SI 指向 48 bytes 資料)：for i := 0Fh downto 0 — out 0A8h,i 後依序 out 0AAh/0ACh/0AEh(綠紅藍)，SI 往前遞增。⚠ 索引遞減而資料遞增，資料第一組對應索引 15。spec 755 的 overlay-11:07CDh 呼叫的就是這一段 | project-status.md<br>spec/775-take-menu-and-palette-writer.md<br>spec/892-new-game-globals.md |
