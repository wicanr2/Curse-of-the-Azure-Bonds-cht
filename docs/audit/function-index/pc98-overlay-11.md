...
| `0508` | sub_508 | INITVARS | 606 | 200 | 1 | 1 | ✓ | 已解讀 | exact | 892<br>同 DOS overlay-11:006D8h 的目的，但★相似度只有 0.110、幾乎各寫各的：緩衝位址整組不同(7F6Eh/8016h/8166h/82B6h/0A81Ah)，多了開頭 81Fh:14h + 0A65h:11DCh + FillChar(966Ch,0D0h)、兩次 194h:39h、一個 for DS:7AD2h:=0 to 0Bh 把 [7AD2h*5−5CFCh] 的 5-byte 記錄填 0FFh、FillChar(0A2C6h,43h)。★DS:8B56h 設 1(DOS 設 0)。兩平台的初始化不共用判讀 | audit/function-strings.md<br>spec/892-new-game-globals.md |
...
| `0800` | sub_800 | — | 40 | 26 | 1 | 1 |  | 已解讀 | exact | docs/spec/775-take-menu-and-palette-writer.md<br>寫入 16 組調色盤(近呼叫 retn，SI 指向 48 bytes 資料)：for i := 0Fh downto 0 — out 0A8h,i 後依序 out 0AAh/0ACh/0AEh(綠紅藍)，SI 往前遞增。⚠ 索引遞減而資料遞增，資料第一組對應索引 15。spec 755 的 overlay-11:07CDh 呼叫的就是這一段 | audit/function-index/dos-overlay-11.md<br>project-status.md<br>spec/775-take-menu-and-palette-writer.md<br>spec/892-new-game-globals.md |
