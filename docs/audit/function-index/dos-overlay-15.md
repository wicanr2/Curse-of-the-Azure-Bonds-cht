...
| `1EFD` | sub_1EFD | — | 188 | 74 | 1 | 3 | ✓ | 待解讀 | — | — | spec/792-memorization-timer-closed.md |
| `1FB9` | sub_1FB9 | — | 178 | 70 | 1 | 2 | ✓ | 已解讀 | exact | docs/spec/770-party-step-and-hug-attack.md<br>三級治療量累加(retf 2，SS 相對記錄)：70 條指令的助憶碼與 PC-98 overlay-15:2020h(spec 763)完全相同 — ss:[p−4] 次 1d8、ss:[p−6] 次 2d8+1、ss:[p−8] 次 3d8+3，累加到 ss:[p−2] | spec/770-party-step-and-hug-attack.md<br>spec/792-memorization-timer-closed.md |
