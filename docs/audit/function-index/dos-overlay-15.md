...
| `0034` | sub_34 | — | 340 | 73 | 1 | 1 | ✓ | 待解讀 | — | — | audit/duplicate-strings.md<br>audit/embedded-strings.md<br>audit/function-index/dos-overlay-14.md<br>audit/function-index/dos-overlay-19.md<br>audit/function-index/dos-overlay-22.md<br>audit/function-index/dos-overlay-23.md |
...
| `0282` | sub_282 | — | 271 | 44 | 2 | 1 | ✓ | 已解讀 | exact | docs/spec/788-memorised-spell-slots-identified.md<br>回傳某職業某等級「還能再記幾個法術」：掃角色 +1Eh..+71h 共 84 格，值 > 0 者取低 7 位當法術編號（最高位＝還在記憶中，見 spec 792），查法術屬性表 DS:37DAh + s*10h 的 +1(等級) 與 +0(職業)，相符就計數（不分最高位）；結果 := 角色^[12Ch + 職業*5 + 等級] − 已記數。retf 4。spec 788／792 | spec/788-memorised-spell-slots-identified.md |
...
| `1EFD` | sub_1EFD | — | 188 | 74 | 1 | 3 | ✓ | 待解讀 | — | — | audit/function-index/dos-overlay-15.md<br>spec/792-memorization-timer-closed.md |
