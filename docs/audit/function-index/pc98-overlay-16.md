...
| `0020` | sub_20 | — | 87 | 36 | 2 | 1 | ✓ | 已解讀 | exact | docs/spec/758-morale-field-0f7h-round-trip.md<br>C 字串轉 Pascal 字串(retf 4)：0A65h:1B0Dh(Move)與 0A65h:649h(StoreString)，其餘同 DOS overlay-16:0020h，含同一個超出參數區的目的指標 | audit/function-index/dos-overlay-15.md<br>audit/function-index/dos-overlay-24.md<br>audit/function-index/pc98-overlay-02.md<br>audit/function-index/pc98-overlay-15.md<br>audit/function-index/pc98-overlay-16.md<br>spec/755-per-character-slots-sound-driver-and-text-io.md |
...
| `1061` | sub_1061 | LOADACTIVEICON | 498 | 183 | 1 | 4 | ✓ | 待解讀 | — | — | audit/embedded-strings.md<br>audit/function-strings.md |
| `1261` | sub_1261 | DELETECHARACTER | 289 | 117 | 2 | 0 | ✓ | 待解讀 | — | — | audit/function-strings.md |
