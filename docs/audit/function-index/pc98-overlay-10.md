...
| `0048` | sub_48 | — | 132 | 55 | 4 | 1 | ✓ | 已解讀 | exact | docs/spec/786-money-pool-overflow-and-turn-cost.md<br>把一格寫進螢幕緩衝(retf 6)：與 DOS overlay-10:0048h 55 條同形，計數器 DS:7AC2h/7AC3h、緩衝 DS:9F2Ch(差異 4 條，已逐條列出) | audit/function-index/dos-overlay-10.md<br>audit/function-index/pc98-overlay-10.md<br>spec/771-extra-attacks-and-weapon-class-whitelist.md<br>spec/786-money-pool-overflow-and-turn-cost.md |
