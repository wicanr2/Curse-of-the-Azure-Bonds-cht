...
| `0CAE` | sub_CAE | — | 88 | 32 | 9 | 1 | ✓ | 已解讀 | exact | docs/spec/757-vroomm-stub-rebuild-image-blit-and-class-slots.md<br>在指標表裡找索引(retf 4)：從 1 起逐格比對 DS:6D35h + i*4 這個遠指標是否等於參數，相等回索引；走到 DS:66A6h(項數)還沒找到回 0 | spec/757-vroomm-stub-rebuild-image-blit-and-class-slots.md |
