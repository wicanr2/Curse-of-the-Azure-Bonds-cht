...
|---|---|---|---:|---:|---:|---:|:-:|---|---|---|---|
| `0000` | sub_0 | LOADTACMAP | 17 | 7 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/569-small-function-batch-reading.md<br>呼叫序列：依序執行 2 個呼叫，沒有其他動作：`call loc_1982+1`、`call loc_19C8+2`（body 共 17 bytes，已逐條讀完） | audit/function-index/dos-overlay-02.md<br>audit/function-index/dos-overlay-10.md<br>audit/function-index/dos-overlay-12.md<br>audit/function-index/dos-overlay-17.md<br>audit/function-index/dos-overlay-24.md<br>audit/function-index/pc98-overlay-24.md |
| `0011` | sub_11 | CALCBIGOFFSET | 104 | 41 | 7 | 1 | ✓ | 已解讀 | exact | docs/spec/783-cross-platform-pairs-first-batch.md<br>二維表查一對 byte(retf 0Ch)：與 DOS overlay-32:0011h 41 條同形，僅表位址為 DS:49ACh/49ADh(差異 2 條，已逐條列出) | audit/function-index/dos-overlay-02.md<br>audit/function-index/dos-overlay-12.md<br>audit/function-index/dos-overlay-17.md<br>audit/function-index/dos-overlay-24.md<br>audit/function-index/dos-overlay-32.md<br>audit/function-index/pc98-overlay-12.md |
...
| `0A1E` | sub_A1E | ONVISSCREEN | 49 | 18 | 6 | 1 | ✓ | 已解讀 | exact | docs/spec/635-overlay32-grid-record-array.md<br>回傳 (0 <= arg_2 <= 6) and (0 <= arg_0 <= 6),用**有號**比較(jl/jg/jle)所以負值被擋掉而不是當成大正數。7×7 = 49 格的座標範圍檢查 | audit/function-index/dos-overlay-32.md<br>audit/function-index/pc98-overlay-32.md<br>spec/635-overlay32-grid-record-array.md |
| `0A4F` | sub_A4F | ONSCREEN | 186 | 79 | 6 | 4 | ✓ | 已解讀 | exact | docs/spec/800-party-reorder-and-footprint-check.md<br>戰鬥員佔地的逐格檢查：i := 本模組 1363h(參數2, 參數4)；byte[9740h + i*4]（戰鬥員記錄 +3 = 佔幾格）為 0 直接回 0；否則 for k := 0 to 3 do if 本模組 0011h(byte[9740h+i*4], k, @dx, @dy) then r := 本模組 0A1Eh(byte[9860h+i] + dx, byte[98A8h+i] + dy)；參數0 <> 0 時 r = 0 立刻回 0（每格都要成立），參數0 = 0 時 r <> 0 立刻回 1（任一格成立即可）。retf 6。spec 800（PC-98 位址由 di 的負位移還原：-68C0h/-67A0h/-6758h） | — |
