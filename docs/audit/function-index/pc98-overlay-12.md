...
| `072E` | sub_72E | — | 52 | 18 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/633-alignment-encoding-and-effect-callbacks.md<br>與 0470h 逐指令相同的另一個遮罩版本:p := arg_6^[18Eh]^[0Ah];if p^[14Ch] and 4 <> 0 then inc DS:0A039h | audit/function-index/pc98-overlay-12.md<br>spec/633-alignment-encoding-and-effect-callbacks.md |
...
| `126D` | sub_126D | — | 51 | 21 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/638-overlay12-effect-batch2.md<br>if DS:0A02Fh and 2 則 DS:0A02Ch += 2;否則若 (DS:0A02Fh and 1) 且 DS:0A042h = 0 則 DS:0A02Eh := byte(DS:0A02Eh × 2)(shl 後只存回 al,溢位靜默丟掉)。與 12A0h 幾乎鏡像但守門的變數不同(這支看 DS:0A042h、那支看 DS:8CF7h),不能合併成一支帶參數的函式 | audit/function-index/pc98-overlay-12.md<br>spec/638-overlay12-effect-batch2.md |
| `12A0` | sub_12A0 | — | 51 | 21 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/638-overlay12-effect-batch2.md<br>與 126Dh 對稱:兩個 bit 對調(先看 and 1 再看 and 2),而守門的變數是 DS:8CF7h 不是 DS:0A042h | audit/function-index/pc98-overlay-12.md<br>spec/638-overlay12-effect-batch2.md |
...
| `19B3` | sub_19B3 | — | 53 | 21 | 0 | 2 | ✓ | 已解讀 | exact | docs/spec/640-save-for-half-and-damage-global.md<br>DS:0A02Fh := 9;<far 013E:0064>(arg_6^[18Eh]^[0Ah], ROLLDICE(2,0Ah)=2d10, 0, 0)。與 19E8h 逐指令相同,只差 DS:0A02Fh 的值與骰子 | spec/640-save-for-half-and-damage-global.md |
| `19E8` | sub_19E8 | — | 53 | 21 | 0 | 2 | ✓ | 已解讀 | exact | docs/spec/640-save-for-half-and-damage-global.md<br>DS:0A02Fh := 10h;<far 013E:0064>(arg_6^[18Eh]^[0Ah], ROLLDICE(1,4)=1d4, 0, 0)。與 19B3h 成對 | spec/640-save-for-half-and-damage-global.md |
