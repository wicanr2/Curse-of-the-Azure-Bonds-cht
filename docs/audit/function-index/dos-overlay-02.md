...
| `0107` | sub_107 | — | 23 | 11 | 1 | 2 | ✓ | 已解讀 | exact | docs/spec/575-random-core-and-pc98-vram.md<br>ECL opcode 02h(GOSUB)的 handler:以參數 1 呼叫兩個 far routine | audit/ecl-opcode-dispatch.md<br>audit/function-index/pc98-overlay-02.md<br>spec/559-full-module-re-sweep.md<br>spec/560-ecl-opcode-dispatch-table.md |
| `011E` | sub_11E | — | 125 | 50 | 1 | 3 | ✓ | 待解讀 | — | docs/spec/560-ecl-opcode-dispatch-table.md<br>ECL opcode 03h 的 handler（binding exact，語意未解讀） | audit/ecl-opcode-dispatch.md<br>audit/embedded-strings.md<br>spec/559-full-module-re-sweep.md<br>spec/560-ecl-opcode-dispatch-table.md |
...
| `09EA` | sub_9EA | — | 156 | 69 | 1 | 3 | ✓ | 待解讀 | — | docs/spec/560-ecl-opcode-dispatch-table.md<br>ECL opcode 11h／12h 的 handler（binding exact，語意未解讀） | audit/ecl-opcode-dispatch.md<br>audit/embedded-strings.md |
...
| `0BBB` | sub_BBB | — | 90 | 33 | 1 | 3 | ✓ | 待解讀 | — | docs/spec/560-ecl-opcode-dispatch-table.md<br>ECL opcode 20h 的 handler（binding exact，語意未解讀） | audit/ecl-opcode-dispatch.md<br>audit/embedded-strings.md |
