...
| `0035` | sub_35 | — | 360 | 148 | 1 | 1 | ✓ | 已解讀 | exact | 852<br>同 DOS overlay-31:00035h（同位址、助憶碼序列完全相同）。14 條差異全是 DS:9F2Eh/9F30h↔6E94h/6E96h 與 Move 呼叫目標 | audit/function-index/dos-overlay-12.md<br>audit/function-index/dos-overlay-22.md<br>audit/function-index/pc98-overlay-12.md |
...
| `03EA` | sub_3EA | LOSEXISTS | 352 | 144 | 1 | 3 | ✓ | 已解讀 | exact | 854<br>同 DOS overlay-31:003EAh（同位址、助憶碼序列完全相同）。只差三條表基底 DS:48ADh/48AEh↔26A3h/26A4h | — |
