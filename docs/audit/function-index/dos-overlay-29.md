...
|---|---|---|---:|---:|---:|---:|:-:|---|---|---|---|
| `0000` | sub_0 | — | 12 | 6 | 0 | 0 | ✓ | 已解讀 | exact | docs/spec/569-small-function-batch-reading.md<br>轉呼叫：整個 body 只準備參數並執行 `call far ptr 19Ch:2Ah`（body 共 12 bytes，已逐條讀完） | audit/embedded-strings.md<br>audit/function-index/dos-overlay-02.md<br>audit/function-index/dos-overlay-17.md<br>audit/function-index/pc98-overlay-02.md<br>audit/overlay-init-graph.md<br>audit/string-pairs.md |
| `000C` | sub_C | — | 133 | 51 | 3 | 1 | ✓ | 已解讀 | exact | docs/spec/785-cross-platform-pairs-third-batch.md<br>retf 0Ah：遠指標為 NIL 就離開；(DS:4F99h^[3FEh] > 0) 或 第三個參數非 0 時走第一條 — +3FEh > 0 才先叫 0297h:1626h(遠指標, 1, 0, @DS:0AA8h, @DS:0A98h)，再叫 0297h:09E4h(遠指標@DS:4FE8h, 遠指標, 0, 0, 參數6−1, 參數8−1) 與 0297h:1316h；否則只叫 0297h:1110h(遠指標, 參數6, 參數8) | audit/embedded-strings.md<br>audit/function-index/dos-overlay-02.md<br>audit/function-index/dos-overlay-29.md<br>audit/function-index/pc98-overlay-02.md<br>audit/function-index/pc98-overlay-29.md<br>spec/753-small-utility-routines.md |
...
| `010B` | sub_10B | — | 1104 | 453 | 0 | 2 | ✓ | 待解讀 | — | — | audit/function-strings.md |
| `055B` | sub_55B | — | 105 | 41 | 2 | 1 | ✓ | 待解讀 | — | — | spec/749-combat-teardown-and-battlefield-grid.md<br>spec/750-combat-setup.md |
| `05DD` | sub_5DD | — | 260 | 110 | 0 | 1 | ✓ | 待解讀 | — | — | audit/function-strings.md |
...
| `0813` | sub_813 | — | 110 | 51 | 0 | 2 | ✓ | 待解讀 | — | — | audit/function-strings.md |
