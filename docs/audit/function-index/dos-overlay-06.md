...
| `0050` | sub_50 | — | 762 | 323 | 1 | 1 | ✓ | 待解讀 | — | — | audit/duplicate-strings.md<br>audit/embedded-strings.md<br>audit/function-strings.md<br>spec/823-shop-price-multiplier.md |
| `0355` | sub_355 | — | 269 | 96 | 1 | 1 | ✓ | 已解讀 | exact | docs/spec/777-item-append-and-area-save-sweep.md<br>把物品複製進背包尾端(retf 8)：<00FDh:004Dh>(物品, DS:6506h) 為真就顯示 CS:034Ah 'OverLoaded' 並把輸出設 1；否則 GetMem 63 bytes、搬進去、next 清 NIL，接在 +14Dh 鏈的**尾端**(空鏈與非空鏈各寫一份程式碼)，最後叫 014Dh:0043h。⚠ 'OverLoaded' 與 overlay-19:2131h 的 'Overloaded' 大小寫不同，是兩條獨立常數 | audit/function-index/pc98-overlay-06.md<br>spec/777-item-append-and-area-save-sweep.md<br>spec/823-shop-price-multiplier.md |
