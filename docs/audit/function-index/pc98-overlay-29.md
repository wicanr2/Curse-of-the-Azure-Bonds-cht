...
| `000C` | sub_C | SHOWPORTRAIT | 133 | 51 | 3 | 1 | ✓ | 待解讀 | — | — | audit/embedded-strings.md<br>audit/function-index/dos-overlay-02.md<br>audit/function-index/dos-overlay-29.md<br>spec/753-small-utility-routines.md<br>spec/754-small-predicates-and-wrappers.md<br>spec/758-morale-field-0f7h-round-trip.md |
...
| `045A` | sub_45A | DISPOSESEQUENCE | 109 | 42 | 2 | 1 | ✓ | 待解讀 | — | — | audit/function-index/pc98-overlay-29.md<br>spec/758-morale-field-0f7h-round-trip.md |
