...
| `000C` | sub_C | SHOWPORTRAIT | 133 | 51 | 3 | 1 | ✓ | 待解讀 | — | — | audit/embedded-strings.md<br>audit/function-index/dos-overlay-02.md<br>spec/753-small-utility-routines.md<br>spec/754-small-predicates-and-wrappers.md<br>spec/758-morale-field-0f7h-round-trip.md |
| `0091` | sub_91 | SHOWHEAD | 34 | 17 | 1 | 1 | ✓ | 已解讀 | exact | docs/spec/569-small-function-batch-reading.md<br>單一呼叫包裝：整個 body 只準備參數並執行 `call near ptr sub_C`（body 共 34 bytes，已逐條讀完） | spec/758-morale-field-0f7h-round-trip.md |
| `00B3` | sub_B3 | SHOWBODY | 37 | 18 | 1 | 1 | ✓ | 已解讀 | exact | docs/spec/754-small-predicates-and-wrappers.md<br>包裝(retf 8)：與 DOS overlay-29:00B3h 位元組相同 | audit/function-index/pc98-overlay-29.md<br>spec/754-small-predicates-and-wrappers.md<br>spec/758-morale-field-0f7h-round-trip.md |
| `010B` | sub_10B | LOADSEQUENCE | 847 | 340 | 0 | 2 | ✓ | 待解讀 | — | — | — |
| `045A` | sub_45A | DISPOSESEQUENCE | 109 | 42 | 2 | 1 | ✓ | 待解讀 | — | — | spec/758-morale-field-0f7h-round-trip.md |
