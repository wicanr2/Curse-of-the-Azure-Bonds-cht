...
| `019E` | sub_19E | — | 86 | 34 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/757-vroomm-stub-rebuild-image-blit-and-class-slots.md<br>清表並拆商餘(retf 2)：把 DS:6F70h 起 5 格 4-byte 清 0；再把 參數 div 5 寫進第 4 格(DS:6F80h)、參數 mod 5 寫進第 3 格(DS:6F7Ch)，高位字都補 0，除法無號。⚠ 同一塊區域在 overlay-21:0F5Bh 被當成遠指標檢查 NIL，這裡當 32-bit 整數用 | audit/function-index/pc98-overlay-21.md<br>spec/757-vroomm-stub-rebuild-image-blit-and-class-slots.md |
...
| `0F5B` | sub_F5B | — | 84 | 30 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/756-map-fill-confirms-grid-and-assorted-routines.md<br>兩個旗標的輸出(retf 8，兩個遠指標都是輸出參數)：a^ := DS:6F70h 起 8 個 4-byte 遠指標中前 7 個有任一非 NIL；b^ := 第 8 個(DS:6F8Ch)非 NIL。兩者先都清 0 | audit/function-index/dos-overlay-21.md<br>audit/function-index/pc98-overlay-21.md<br>spec/756-map-fill-confirms-grid-and-assorted-routines.md<br>spec/757-vroomm-stub-rebuild-image-blit-and-class-slots.md |
