...
| `0115` | sub_115 | — | 107 | 37 | 1 | 5 | ✓ | 已解讀 | exact | docs/spec/758-morale-field-0f7h-round-trip.md<br>retf，無參數：隊伍鏈頭 DS:9598h 為 NIL 或 DS:7F05h^[3FAh] 非 0 就離開；否則叫 sub_3BF4h(DS:7F56h 遠指標, @DS:4830h, 0, 0A8h, 2Ah, 0, 0) 與兩個無參數呼叫，把狀態變數 DS:7F27h 設成 4(戰鬥開場是 5)，再 sub_14CAh(DS:9594h)、DS:7F09h^[550h] := 0 | audit/embedded-strings.md<br>audit/function-index/dos-overlay-22.md<br>spec/758-morale-field-0f7h-round-trip.md |
