...
| `2690` | sub_2690 | — | 81 | 35 | 0 | 2 | ✓ | 已解讀 | exact | docs/spec/629-spell-pack-idiom-and-uninit.md<br>case DS:0A520h of 1:(DS:0A031h=17h ? 0FEh : 0FDh) 2:0FFh 3,4:0——**沒有 else**,落在 1..4 以外時傳給 <sub_1D0B> 的 v 是未初始化的堆疊殘值(與 spec 624 的 7D0Dh 同一類原作行為)。訊息「は金縛りにあった。」 | spec/629-spell-pack-idiom-and-uninit.md |
...
| `2776` | sub_2776 | — | 168 | 62 | 0 | 4 | ✓ | 已解讀 | exact | docs/spec/629-spell-pack-idiom-and-uninit.md<br>t := DS:0A521h;若 t^[196h]=1 就把 DS:0A521h 清成 nil 且不印訊息(呼叫端不檢查會拿到 nil);否則 <far 014A:00A7>(37h,t,@var_4) 非 0 時,若 t^[1A5h]=0 才拉到 1(HP 為 0 才救回,不是治療,活著的人不會加血),備妥「は魔法にかかった。」呼叫 <sub_F62>,最後 <far 013E:002A>(4Eh,t,0,1) | spec/629-spell-pack-idiom-and-uninit.md<br>spec/630-spell-target-array.md |
| `282D` | sub_282D | — | 174 | 67 | 0 | 2 | ✓ | 已解讀 | exact | docs/spec/630-spell-target-array.md<br>挑目標填進陣列:budget := DS:9594h^[1A5h](存 DS:7D93h),掃 DS:9598h 角色鏈,+11Ah(RACETYPE)=0Eh 且 budget >= p^[1A5h] 時扣掉該值、inc DS:0A520h、把 far pointer 存進 [0A51Dh + 4×索引]。索引由 1 開始,所以 DS:0A521h 就是第 1 筆——這解釋了其他法術函式都在讀的那個位址。逐個扣預算不是固定選 N 個,扣不動的整個跳過(不會部分影響),而且預算歸零後仍走完整條鏈。訊息「は魅了された。」 | spec/630-spell-target-array.md |
...
| `3223` | sub_3223 | — | 61 | 25 | 0 | 3 | ✓ | 已解讀 | exact | docs/spec/628-spell-effect-wrappers.md<br>if <far 013E:0070>(21h, DS:0A521h:0A523h) <> 0 then <far 014A:00A2>(目標,1,'の視力は戻った。')。與 41AFh 分支方向相反,交叉確定 013E:0070 是「目標身上有沒有這個效果」,21h 是失明 | audit/function-index/dos-overlay-22.md<br>spec/628-spell-effect-wrappers.md |
...
| `41AF` | sub_41AF | — | 65 | 32 | 0 | 3 | ✓ | 已解讀 | exact | docs/spec/628-spell-effect-wrappers.md<br>if <far 013E:0070>(2Ah, DS:0A521h:0A523h) = 0 then 推入 DS:0A031h 與四個 0、備妥'はすばやくなった。' 呼叫 <sub_F62>。沒有該效果才施放,故 2Ah 是加速 | audit/function-index/dos-overlay-22.md<br>audit/function-index/pc98-overlay-22.md<br>spec/628-spell-effect-wrappers.md |
