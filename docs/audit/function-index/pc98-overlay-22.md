...
| `41F0` | sub_41F0 | — | 64 | 26 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/755-per-character-slots-sound-driver-and-text-io.md<br>retf，無參數：DS:0A520h 非 0 時，r := ROLLDICE(8,2)，若 overlay-23 entry#22 @2419h(0, r+1) 為真則叫 overlay-24 entry#29 @2776h(遠指標@DS:0A521h) | spec/755-per-character-slots-sound-driver-and-text-io.md |
...
| `4687` | sub_4687 | — | 66 | 26 | 0 | 1 | ✓ | 已解讀 | exact | docs/spec/755-per-character-slots-sound-driver-and-text-io.md<br>與 41F0h 同一段的第二份實例：ROLLDICE(8,3)、r+3，其餘相同 | spec/755-per-character-slots-sound-driver-and-text-io.md |
