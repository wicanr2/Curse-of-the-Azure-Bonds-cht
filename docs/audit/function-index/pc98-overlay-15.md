...
| `0034` | sub_34 | — | 340 | 121 | 1 | 2 | ✓ | 待解讀 | — | — | audit/duplicate-strings.md<br>audit/embedded-strings.md<br>audit/function-index/dos-overlay-22.md<br>audit/function-index/dos-overlay-23.md |
| `0188` | sub_188 | — | 67 | 24 | 2 | 1 | ✓ | 已解讀 | exact | docs/spec/755-per-character-slots-sound-driver-and-text-io.md<br>清掉超界值(retf 4)：與 DOS overlay-15:0188h 位元組相同 | spec/755-per-character-slots-sound-driver-and-text-io.md |
| `01CB` | sub_1CB | — | 115 | 42 | 3 | 2 | ✓ | 待解讀 | — | — | audit/embedded-strings.md<br>spec/755-per-character-slots-sound-driver-and-text-io.md |
| `023E` | sub_23E | — | 68 | 27 | 1 | 3 | ✓ | 已解讀 | exact | docs/spec/755-per-character-slots-sound-driver-and-text-io.md<br>整隊清理(retf)：鏈頭 DS:9598h、next 在 +18Ah，其餘同 DOS overlay-15:023Eh | spec/755-per-character-slots-sound-driver-and-text-io.md |
...
| `147B` | sub_147B | — | 85 | 37 | 1 | 1 | ✓ | 待解讀 | — | — | audit/function-index/pc98-overlay-15.md |
