...
| `01AB` | sub_1AB | — | 192 | 68 | 1 | 1 | ✓ | 待解讀 | — | — | audit/function-index/dos-overlay-08.md<br>spec/769-combat-main-loop.md |
| `026B` | sub_26B | — | 325 | 102 | 1 | 3 | ✓ | 待解讀 | — | — | audit/function-index/dos-overlay-08.md<br>spec/769-combat-main-loop.md |
...
| `0997` | sub_997 | — | 317 | 112 | 1 | 3 | ✓ | 待解讀 | — | — | audit/function-index/dos-overlay-08.md<br>spec/769-combat-main-loop.md |
...
| `0C94` | sub_C94 | — | 2 | 1 | 2 | 1 |  | 已解讀 | exact | docs/spec/569-small-function-batch-reading.md<br>尾呼叫：最後一條是 `jmp short loc_CE0`，控制權轉交後不返回（body 共 2 bytes，已逐條讀完） | audit/function-index/dos-overlay-08.md<br>spec/769-combat-main-loop.md |
