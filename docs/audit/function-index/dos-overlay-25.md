...
| `134A` | sub_134A | — | 80 | 29 | 2 | 1 | ✓ | 已解讀 | exact | docs/spec/756-map-fill-confirms-grid-and-assorted-routines.md<br>第一個非零的職業欄位(retf 4)：p^[74h] 不等於 7 就回 0；否則在 p^[109h..10Fh] 找第一個非零 byte 回傳。⚠ 七格全為 0 時索引停在 7，會讀到 p^[110h](超出這七格) | spec/756-map-fill-confirms-grid-and-assorted-routines.md |
