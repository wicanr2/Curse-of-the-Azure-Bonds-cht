...
| `1B645` | @Random$q4Word | — | 22 | 10 | 5 | 2 |  | 已解讀 | exact | docs/spec/575-random-core-and-pc98-vram.md<br>@Random(n) 本體:呼叫 sub_1B694 取得 32-bit 亂數,參數 n 為 0 時回傳 0,否則以 n 做除法並回傳餘數(xchg/div/xchg 把餘數搬進 ax) | — |
