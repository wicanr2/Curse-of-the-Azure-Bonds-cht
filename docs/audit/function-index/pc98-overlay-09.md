...
| `13A5` | sub_13A5 | — | 111 | 36 | 1 | 4 | ✓ | 已解讀 | exact | docs/spec/758-morale-field-0f7h-round-trip.md<br>士氣判定(retf 4)：兩段訊息 CS:1385h 'は退散させられた。' 與 CS:1398h 'は降伏した。'。p^[18Eh]^[10h] 非 0 走第一條；否則要 p^[0F7h] > 7Fh，取 (and 7Fh)*2(>66h 歸 0)，再與受傷百分比 100−(p^[1A5h]*100 div p^[78h]) 及 100−DS:7F09h^[58Ch] 兩次比較，最後 a <= b div 2 或 p^[13h] > 5 決定結局。兩條路都設 p^[18Eh]^[14h]:=1。⚠ 舊 DS:0A03Ch 存進 [bp-3] 後整支沒再讀(死存放，不會還原) | audit/function-index/dos-overlay-02.md<br>spec/758-morale-field-0f7h-round-trip.md |
