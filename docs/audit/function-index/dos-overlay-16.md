...
| `0C7E` | sub_C7E | — | 157 | 63 | 2 | 0 | ✓ | 已解讀 | exact | 868<br>角色檔三件組(retf 4，一個遠指標)：路徑 := DS:5BF0h ＋ 636h:618h(arg_0)，指派給上限 50h 的緩衝，再對 '.guy'/'.swg'/'.fx' 各串一次並叫 636h:192h。前綴只組一次、三個副檔名共用 | audit/function-strings.md<br>spec/868-character-file-triplet.md |
