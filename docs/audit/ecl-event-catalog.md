...
| `ECL2.DAX/0x02/0x04BC-0x053A` | per_turn | `0x04BC COMBAT [combat_boundary]` → `0x04BD PRINTCLEAR [text]` → `0x04E8 PRINT [text]` → `0x0500 PRINT [text]` → `0x052D PRINT [text]` | 未審查 | `static_straight_line_candidate` |
