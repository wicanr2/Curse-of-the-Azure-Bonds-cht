...
解析器實際讀到的位元組（5 份基準記錄的聯集）：**286／422**。
...
| `+072h` | 1 | （未定） | `unknown` | — | 0 |
| `+073h` | 1 | 重算時抄進 +199h 的來源 | `documented` | spec 1000 | 0 |
...
| `+11Dh` | 2 | 攻擊骰數 基準（兩個武器槽） | `documented` | spec 1000／795 | 0 |
| `+11Fh` | 2 | 攻擊面數 基準 | `documented` | spec 1000／795 | 0 |
| `+121h` | 2 | 傷害加值 基準（有號） | `documented` | spec 1000／795 | 0 |
| `+123h` | 1 | （未定） | `unknown` | — | 0 |
| `+124h` | 1 | 重算時抄進 +19Ah 的來源 | `documented` | spec 1000 | 0 |
| `+125h` | 2 | （未定） | `unknown` | — | 0 |
...
| `+19Ah` | 1 | 重算時由 +124h 抄過來 | `documented` | spec 1000 | 0 |
| `+19Bh` | 1 | 本回合選用的武器槽 | `documented` | spec 1010 | 0 |
| `+19Ch` | 1 | 本回合的攻擊次數（每回合重算） | `documented` | spec 808 | 0 |
| `+19Dh` | 2 | 攻擊骰數 現值（兩個武器槽） | `documented` | spec 1000／795 | 0 |
| `+19Fh` | 2 | 攻擊面數 現值 | `documented` | spec 1000／795 | 0 |
| `+1A1h` | 2 | 傷害加值 現值（有號） | `documented` | spec 1000／795 | 0 |
| `+1A3h` | 1 | （未定） | `unknown` | — | 0 |
