...
- 已從 `CHEAD.DAX`＋`CBODY.DAX` 合成六張原作風格 party combat icon，Ebiten party fighter 會優先顯示這些小人；合成規則與跨 Gold Box 知識整理在 [`docs/knowledge/gold-box-graphics.md`](docs/knowledge/gold-box-graphics.md)。
