...
| 規格 | 1,131 份 `docs/spec/*.md`，各自標證據等級與「明確不宣稱」邊界 |
| 程式 | 362 個 `.go`／105,248 行；`internal/game` 沒有區域或劇情專屬檔 |
| ECL 文字 | 控制流可達 1,022 頁，**未接上 0** |
| ECL 副作用 | 可達 14,177 條指令，**只讀掉運算元 0**、部分完成 1,024 |
...
| UI 詞條 | game pack `zh-TW` 1,426 條、`assets/locale/zh-TW.json` 916 條 |
